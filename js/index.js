...
////////////// *************  Routing  ****************************** ////////////////////
    ...
    /////////  *************  starting cor java  routing  *************  ////////////
            ...
            .when('/', {
                ...
                templateUrl: 'template/java/singleton.html',
                controller: 'singletonCtrl'
            })
    ...
    ///// ************* starting UNIX  routing ****************** /////
            ...
            .when('/basicLinux', {
                templateUrl: 'template/unix/basicLinux.html',
                controller: 'basicLinuxCtrl'
            }).when('/linuxCommand', {
                templateUrl: 'template/unix/linuxCommand.html',
    ...
    /////  ************* starting MISCELLANEOUS  routing  ************* /////
            ...
            }).when('/windowsShortcut', {
                templateUrl: 'template/windowsShortcut.html'
               //, controller: 'windowsShortcutCtrl'
            })
...
//            if (event.ctrlKey || event.metaKey || (event.keyCode == 123)) {
...
//                console.log("cccccccc11111111111111 "+c);
//                switch (c) {
//                    case 16:e.preventDefault();
//                        e.stopPropagation();
//                        case 17:e.preventDefault();
//                        e.stopPropagation();
//                        case 73:e.preventDefault();
//                        e.stopPropagation();
//                    case 83: alert(83);//Block Ctrl+S
...
//        };
        ...
        var isClickctrl = false ;
        $(document).keydown(function (event) {
            if (event.keyCode == 123) { // Prevent F12 
                isClickctrl = false ;
                alert("un authorize F12 ---");
                return false;
...
//               isClickctrl = true; 
//            }else if(isClickctrl && event.keyCode == 83){
//                alert('Ctrl+S');
//                return false;
//            }
...
//            else if (event.ctrlKey){
//                if((event.shiftKey && event.keyCode == 73)|| event.keyCode == 83)
//                {
//                    alert("un authorize");
//                    return false;
//                }
...
//            else if ((event.ctrlKey && event.shiftKey && event.keyCode == 73) || (event.ctrlKey && event.keyCode == 17)) { // Prevent Ctrl+Shift+I        
//                alert("un authorize");
//                return false;
//            }
        });
...
//            console.log("screen.width - " + screen.width);
        ...
        programmingTutorial.controller('singletonCtrl', function ($scope, $rootScope) {
            $rootScope.hideMenuBarButt = false;

            $scope.singleton = false;
            $scope.singleton1 = false;
            $scope.singleton2 = false;
            $scope.singleton3 = false;
            $scope.singleton4 = false;
            $scope.singleton5 = false;
            $scope.singleton6 = false;
            $scope.singleton7 = false;
            $scope.singleton8 = false;
            $scope.singleton9 = false;
            $scope.singleton10 = false;
            $scope.singleton11 = false;
            $scope.singleton12 = false;
            $scope.singleton13 = false;
            $scope.singleton14 = false;
            $scope.singleton15 = false;

            $scope.toggle = function () {
                $scope.singleton = !$scope.singleton;
            };
            $scope.toggle1 = function () {
                $scope.singleton1 = !$scope.singleton1;
            };
            $scope.toggle2 = function () {
                $scope.singleton2 = !$scope.singleton2;
            };
            $scope.toggle3 = function () {
                $scope.singleton3 = !$scope.singleton3;
            };
            $scope.toggle4 = function () {
                $scope.singleton4 = !$scope.singleton4;
            };
            $scope.toggle5 = function () {
                $scope.singleton5 = !$scope.singleton5;
            };
            $scope.toggle6 = function () {
                $scope.singleton6 = !$scope.singleton6;
            };
            $scope.toggle7 = function () {
                $scope.singleton7 = !$scope.singleton7;
            };
            $scope.toggle8 = function () {
                $scope.singleton8 = !$scope.singleton8;
            };
            $scope.toggle9 = function () {
                $scope.singleton9 = !$scope.singleton9;
            };
            $scope.toggle10 = function () {
                $scope.singleton10 = !$scope.singleton10;
            };
            $scope.toggle11 = function () {
                $scope.singleton11 = !$scope.singleton11;
            };
            $scope.toggle12 = function () {
                $scope.singleton12 = !$scope.singleton12;
            };
            $scope.toggle13 = function () {
                $scope.singleton13 = !$scope.singleton13;
            };
            $scope.toggle14 = function () {
                $scope.singleton14 = !$scope.singleton14;
            };
            $scope.toggle15 = function () {
                $scope.singleton15 = !$scope.singleton15;
            };
